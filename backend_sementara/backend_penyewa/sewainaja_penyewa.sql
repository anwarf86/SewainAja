...
--
-- Host: 127.0.0.1    Database: sewainaja
-- ------------------------------------------------------
...
CREATE TABLE `penyewa` (
  `id_penyewa` int(150) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `penyewa` VALUES (1,'Teuku','teukumuhaimin@gmail.com','1234567890','shghsehgsoebhoenbonbinbbneprpr','1234567890','aktiv'),(3,'ando','yoyo@gmail.com','12345645','imagwhuidhwewidjtgg','0756','lega');
/*!40000 ALTER TABLE `penyewa` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'sewainaja'
--

--
-- Dumping routines for database 'sewainaja'
--
...
-- Dump completed on 2022-06-12  8:14:21
-- MySQL dump 10.13  Distrib 5.6.23, for Win32 (x86)
--
...
-- Dump completed on 2022-06-12  8:14:22
